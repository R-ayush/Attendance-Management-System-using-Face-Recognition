    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='Yash@123', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Yash raj/Desktop/drive-download-20241219T123315Z-001/Attendance/Manually Attendance/'+DB_table_name+'.csv'
